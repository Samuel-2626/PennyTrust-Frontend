  ...
  return (
    <div>
      ...
      <Jumbotron className="jumbotron text-white">
        <Container>
          <h1 className="darkorange"><strong>Welcome to PennyTrust Inc.&trade;</strong></h1>
          <p>
      ...
      <div className="orange-bg">
        <Container>
          ...
          <Row className="text-center">
            ...
            <br />
            <p className="dark-text">
            At Penny Trust we are determined to make financial loans accessible to those who need it most. You can apply for a Credit Wallet loan from the comfort of your own home, anytime of the day.
            </p>
            </Col>
            <Col lg={4} className="work">
      ...
      <div className="text-center p-5 mobile-app border-top">
        <Container>
       <Zoom>
       <h2 className="darkorange"><strong>PENNYTRUST INC. MOBILE APP</strong></h2>
       </Zoom>
  
              
           
              <p className="">
              Download the Penny Trust App and simplify your Loan Processing. Discover quick, simple and convenient way to take request and manage your loanapplications, on your mobile phone.
              </p>
