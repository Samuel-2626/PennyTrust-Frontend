   ...
   <Container className="mb-5">
       ...
       <Accordion defaultActiveKey="0">
         <Card>
           ...
           <strong>Who is PennyTrust Inc? Which bank are you affiliated with?</strong>
           </Accordion.Toggle>
           <Accordion.Collapse eventKey="0">
             <Card.Body>
             PennyTrust Inc. is licensed lender based in Lagos, Nigeria. We are determined to make financial credit accessible to those who need it most. Today we are doing so by offering loans to hundreds of salary earners in Nigeria.
